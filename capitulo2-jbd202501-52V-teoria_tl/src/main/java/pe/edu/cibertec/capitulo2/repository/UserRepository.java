...
public class UserRepository {
    ...
    public UserRepository (){
        ...
        listaUser.add(new UserDto("pguerreo","123456","Paolo Guerrero"));
        listaUser.add(new UserDto("jfarfan","123456","Jefferson Farfan"));
        listaUser.add(new UserDto("cpizarro","123456","Claudio Pizarro"));
    }
